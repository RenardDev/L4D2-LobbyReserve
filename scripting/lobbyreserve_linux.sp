...
public void OnPluginStart()
{
    ...
    g_hGameConf = LoadGameConfigFile("l4d2_lobbyreserve_runtime_linux");
    if (!g_hGameConf)
    {
        SetFailState("Failed to load gamedata: l4d2_lobbyreserve_runtime_linux.");
    }
    ...
    if (!ValidateAll())
    {
        SetFailState("Patch validation failed (Linux).");
    }
